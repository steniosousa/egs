...
export default function CRLVView({ dadosCRLV, escolherEmpresa, setDadosCRLV }: { dadosCRLV: CRLV, escolherEmpresa: string, setDadosCRLV: (dados: CRLV) => void }) {
    ...
    const criarProprietario = async () => {
        ...
        proprietário.RAZAOSOCIAL = dadosCRLV.proprietario
        proprietário.RNTC = dadosCRLV.rntc_proprietatio
        ...
        try {
            ...
            veiculo.IDCADASTRO = data.IDCADASTRO
                        ...
                        <div className="grid md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    value={dadosCRLV.cpf}
                                    onChange={(e) => {
                                        setDadosCRLV({ ...dadosCRLV, cpf: e.target.value });
